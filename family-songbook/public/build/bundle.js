...
var app = (function () {
    ...
    /* src\components\PostCard.svelte generated by Svelte v3.47.0 */
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			em = element("em");
    			t0 = text("dedicated to ");
    			t1 = text(/*dedicated*/ ctx[3]);
    			attr_dev(em, "class", "dedicated");
    			add_location(em, file$1, 9, 27, 194);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*dedicated*/ 8) set_data_dev(t1, /*dedicated*/ ctx[3]);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	let div0;
    	let t3;
    	let if_block = /*dedicated*/ ctx[3] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 8, 2, 147);
    			attr_dev(div0, "class", "lyrics");
    			add_location(div0, file$1, 11, 2, 263);
    			attr_dev(div1, "class", "song");
    			attr_dev(div1, "id", /*id*/ ctx[0]);
    			add_location(div1, file$1, 7, 0, 117);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { title } = $$props;
    	let { body } = $$props;
    	let { dedicated = undefined } = $$props;
    	const writable_props = ['id', 'title', 'body', 'dedicated'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('dedicated' in $$props) $$invalidate(3, dedicated = $$props.dedicated);
    	};

    	$$self.$capture_state = () => ({ id, title, body, dedicated });
    	...
    	return [id, title, body, dedicated];
    }

    class PostCard extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { id: 0, title: 1, body: 2, dedicated: 3 });
    		...
    		if (/*body*/ ctx[2] === undefined && !('body' in props)) {
    			console.warn("<PostCard> was created without expected prop 'body'");
    		}
    	}
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			div.textContent = "404 — 😞 No Songs Found. Contact the developer";
    			add_location(div, file, 46, 3, 1680);
    		},
    		m: function mount(target, anchor) {
    ...
    // (44:2) {#each posts as post (post.id)}
    function create_each_block(key_1, ctx) {
    	let first;
    	let postcard;
    	let current;
    	const postcard_spread_levels = [/*post*/ ctx[5]];
    	let postcard_props = {};

    	for (let i = 0; i < postcard_spread_levels.length; i += 1) {
    		postcard_props = assign(postcard_props, postcard_spread_levels[i]);
    	}

    	postcard = new PostCard({ props: postcard_props, $$inline: true });
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			const postcard_changes = (dirty & /*posts*/ 1)
    			? get_spread_update(postcard_spread_levels, [get_spread_object(/*post*/ ctx[5])])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(44:2) {#each posts as post (post.id)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			header.textContent = "Welcome to the Family Songbook!";
    			t1 = space();
    			div1 = element("div");
    			if (if_block) if_block.c();
    			t2 = space();
    			div0 = element("div");
    			add_location(header, file, 40, 0, 1521);
    			add_location(div0, file, 52, 1, 1943);
    			attr_dev(div1, "class", "container");
    			add_location(div1, file, 41, 0, 1570);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					action_destroyer(inview.call(null, div0, {})),
    					listen_dev(div0, "change", /*handleChange*/ ctx[1], false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const fetchData = async page => {
    		...
    		let res = {
    			data: json.slice(PAGE_SIZE * (page - 1), PAGE_SIZE * page)
    		};

    		// If we were able to get more posts, add them to our posts array
    		if (res.data.length > 0) $$invalidate(0, posts = [...posts, ...res.data]); else // Otherwise we'll know we've reached the end of results
    		hasMore = false;
    	};
